...
public class LoginUIController implements Initializable {
    ...
    @FXML
    private void handleLoginButton(ActionEvent actionEvent) throws SQLException, IOException {
    ...
    @FXML
    private void handlesendcode(ActionEvent event) throws SQLException, AddressException, MessagingException {
